		...
		<div class="pinItem">
			<div class="pinBox pinWell margin-bottom-15"> 
				<a href="/product/item/{$product[idx].product}/{$product[idx].name}">
					<img class="img-responsive img-popover" width="500" src="{if $product[idx].image != ''}https://api.powerdd.com/img/remax/product/{$product[idx].sku}/300/300/{$product[idx].image}{else}http://src.powerdd.com/img/product/88888888/default.jpg{/if}">
				</a>
				<div class="message">
