<div class="pinBox pinWell padding-10">
	<div class="row">
		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 margin-top-10 margin-bottom-10" align="right"> 
			...
			<span class="btn btn-primary" type="button" id="btn-claim">ส่งข้อมูลการเคลม</span>
	    </div>
	</div>
</div>
