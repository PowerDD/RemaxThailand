				...
				<div class="text-center">
					<div id="check_warranty" class="padding-10">
						<form id="f_warranty" class="form-horizontal">
							...
							<a id="btn-condition_warranty" class="button-warranty form-control btn btn-danger btn-block margin-top-5 margin-bottom-5" type="button" href="{$system_url}/claim"> เงื่อนไขการรับประกัน</a>
