	...
	<div id="form-input" class="row margin-bottom-15">
		...
		<form>
			<div class="form-group text-danger">
				...
				<span id="btn-barcode" align="center" class="btn btn-warning margin-top-5">ตรวจสอบ</span>
			</div>
		</form>
	    </div>
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 margin-bottom-15">
		<form>
			<div class="form-group text-danger">
				...
				<span id="btn-claimno" align="center" class="btn btn-warning margin-top-5">ตรวจสอบ</span>
			</div>
		</form>
	    </div>
	</div>
